...
VT_MINE = {
  [CHAR_SOUND_ATTACKED] = { 'mine_dmg1.mp3', 'mine_dmg3.mp3', 'mine_dmg2.mp3' },
  ...
  [CHAR_SOUND_GROUND_POUND_WAH] = {'mine_atk4.mp3'},
  [CHAR_SOUND_HAHA] = {'mine_fufu.mp3'}, -- Landing after backflip
  ...
  [CHAR_SOUND_ON_FIRE] = {'mine_dmg1.mp3'}, -- Touch Fire
  [CHAR_SOUND_OOOF] = 'mine_ah1.mp3',                                                 -- Grabbed by Chuckya
  [CHAR_SOUND_OOOF2] = 'mine_dmg3.mp3',                                               -- Landing After a Bonk + Thrown out of level + Also bonk into walls?
  ...
  [CHAR_SOUND_TWIRL_BOUNCE] = { 'sfx_smw_spring.mp3' },  -- Boing
  [CHAR_SOUND_UH] = 'sfx_smrpg_drop.mp3', -- Drop off of ledge + Fall off Ledge
  [CHAR_SOUND_UH2] = { 'mine_atk3.mp3' },                -- Quick Ledge Get-Up
  -- [CHAR_SOUND_UH2_2] = 'silent.mp3', -- Landing after Long Jump
  [CHAR_SOUND_WAAAOOOW] = 'mine_falling.mp3', -- Falling
  [CHAR_SOUND_WAH2] = { 'mine_atk1.mp3' },              -- Throw Object
  [CHAR_SOUND_WHOA] = 'sfx_ssb64_ledge.mp3', -- Ledge Grab
  [CHAR_SOUND_YAHOO] = { 'mine_jump2.mp3' },             -- Long Jump
  [CHAR_SOUND_YAHOO_WAHA_YIPPEE] = { 'mine_atk4.mp3' }, -- 3rd Jump(s)
  [CHAR_SOUND_YAH_WAH_HOO] = { 'mine_jump1.mp3', 'mine_atk3.mp3', 'mine_atk1.mp3' },      -- 1st Jump(s)
}
