...
local type, audio_sample_stop, audio_sample_load, math_random, audio_sample_play, is_game_paused, table_insert, play_character_sound =
    type, audio_sample_stop, audio_sample_load, math.random, audio_sample_play, is_game_paused, table.insert,
...
------------------------------------------------------------------
-- slightly modified for use with BA Mod
------------------------------------------------------------------
