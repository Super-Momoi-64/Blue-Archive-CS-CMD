...
E_MODEL_TSUKUYO2 = smlua_model_util_get_id("tsukuyo2_geo")
E_MODEL_MICHIRU = smlua_model_util_get_id("michiru_geo")
E_MODEL_MICHIRU2 = smlua_model_util_get_id("michiru2_geo")
...
TEX_TSUKUYO2 = get_texture_info("Tsukuyo_Dress_Icon")
TEX_MICHIRU = get_texture_info("Michiru_Icon")
TEX_MICHIRU2 = get_texture_info("michirudressicon")
